                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="max-w-xl text-lg leading-relaxed text-muted-foreground">
                                Conecta estudiantes y egresados con oportunidades de pasantía forma rápida, moderna y organizada.
                            </p>
                        </div>
                    ...
                    <div className="flex items-center justify-center">
                        <div className="w-full max-w-sm rounded-2xl border bg-background/80 p-6 shadow-md">
                            ...
                            <p className="text-sm leading-relaxed text-muted-foreground">
                               Encuentra tu primera experiencia laboral, prácticas profesionales y proyectos reales tu área de estudio.
                            </p>
                        </div>
                    </div>
                </CardContent>
